...
namespace DatabaseMigrations.Repositories.Abstractions
{
    ...
    {
        public Task<int> AddProductAsync(string name, string discription, int supplierId, int categoryId, decimal unitPrice, float discount, List<OrderDetailEntity> inOrders);
